...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class RetrofitLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        private final RetrofitRxLibraryAccessors laccForRetrofitRxLibraryAccessors = new RetrofitRxLibraryAccessors(owner);
        ...
        /**
         * Returns the group of libraries at retrofit.rx
         */
        public RetrofitRxLibraryAccessors getRx() {
            return laccForRetrofitRxLibraryAccessors;
        }
    ...
    public static class RetrofitRxLibraryAccessors extends SubDependencyFactory {

        public RetrofitRxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for adapter (com.squareup.retrofit2:adapter-rxjava3)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getAdapter() {
                return create("retrofit.rx.adapter");
        }
    ...
    public static class RxLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Returns the group of libraries at rx.java
         */
        public RxJavaLibraryAccessors getJava() {
    ...
    public static class RxJavaLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public RxJavaLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for java (io.reactivex.rxjava3:rxjava)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> asProvider() {
            ...
            /**
             * Creates a dependency provider for android (io.reactivex.rxjava3:rxandroid)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getAndroid() {
                return create("rx.java.android");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: okhhtp (4.7.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getOkhhtp() { return getVersion("okhhtp"); }
    ...
    public static class RxVersionAccessors extends VersionFactory  {
        ...
        public RxVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: rx.java (3.1.8)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
